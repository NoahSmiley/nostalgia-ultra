...
export const SERVER_CONFIG = {
  ...
  ip: process.env.NEXT_PUBLIC_SERVER_IP || 'n1429.pufferfish.host',
  port: 25565,
  ...
  // Modpack - hosted via GitHub raw (direct download link for Prism Launcher import)
  modpackUrl: process.env.NEXT_PUBLIC_MODPACK_URL || 'https://raw.githubusercontent.com/NoahSmiley/noahs-server-modpack/main/Noahs-Server.mrpack',
  modCount: 50,
